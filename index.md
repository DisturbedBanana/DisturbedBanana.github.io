...
<style>
  ...
  @keyframes pulse-glow {
    0%, 100% { box-shadow: 0 0 50px rgba(231, 76, 60, 0.3); }
    25% { box-shadow: 0 0 50px rgba(52, 152, 219, 0.3); }
    50% { box-shadow: 0 0 50px rgba(155, 89, 182, 0.3); }
    75% { box-shadow: 0 0 50px rgba(46, 204, 113, 0.3); }
  }
